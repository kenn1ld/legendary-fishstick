...
import { Button, Typography, Box, Paper, Grid, Card, Container, LinearProgress, Alert } from '@mui/material';
...
const FootballComponent: React.FC = () => {
  const { leagues, topScorers, error, loading, fetchTopScorers } = useFootballData();
    ...
    <Container>
      <Box sx={{ p: 3, bgcolor: 'background.paper', borderRadius: 2 }}>
        <Header>
          ...
          <Typography variant="h4" component="div" color="white">Football Stats</Typography>
        </Header>
      ...
      {fetchTimeout && !loading && <Alert severity="error" sx={{ mb: 2 }}>Fetching data took longer than expected. Please try again.</Alert>}
